...
html: clean prepare copy_images
	docker run --rm -v $(CURDIR):/documents/ asciidoctor/docker-asciidoctor asciidoctor -o index.html $(REQUIRESTRING) $(OUTPUTSTRING) $(PLATUMLSTRING) main.adoc

pdf: clean prepare copy_images
	docker run --rm -v $(CURDIR):/documents/ asciidoctor/docker-asciidoctor asciidoctor-pdf -o documentation.pdf $(REQUIRESTRING) $(OUTPUTSTRING) $(PLATUMLSTRING) main.adoc
